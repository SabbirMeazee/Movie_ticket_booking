...
border-primary/20 rounded-md max-w-50 w-full">
            ...
            {/* ///////Active Shows//////// */}
            <p className="mt-10 text-1g font-medium">Active Shows</p>
            <div className="relative flex flex-wrap gap-6 mt-4 max-w-5x1">
                ...
                h-full pb-3 bglprimary/10 border border-primary/20
hover:-translate-y-1 transition duration-300">
                        <img src={image_bage_url + show.movie.poster_path} alt='' className="h-60 w-full object-cover" />
